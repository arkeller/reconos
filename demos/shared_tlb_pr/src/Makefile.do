...
EDK_BASE_DIR ?= $(RECONOS)/hw/refdesigns/$(XILINX_VER)/xup/xup_light
...
#PCORE_OSIF=$(RECONOS)/hw/pcores/xps_osif_$(RECONOS_VER) $(RECONOS)/hw/pcores/plb_osif_$(RECONOS_VER) $(RECONOS)/hw/pcores/osif_core_$(RECONOS_VER)
#PCORE_RECONOS=$(RECONOS)/hw/pcores/reconos_$(RECONOS_VER)
# fifo cores
#PCORE_FIFO=$(RECONOS)/hw/pcores/mbox_fifo_v1_01_a
# burst ram cores
#PCORE_BURSTRAM=$(RECONOS)/hw/pcores/burst_ram_$(RECONOS_VER)
# MGT protector (for V4FX engineering samples)
#PCORE_MGTPROTECTOR=$(RECONOS)/hw/pcores/v4_mgt_protector_v1_00_a
...
ADDOSIF=$(RECONOS)/tools/python/mhsaddosif_sharedmem.py
ADDDRIVER=$(RECONOS)/tools/python/mssadddriver_sharedmem.py
ADDTHREAD=$(RECONOS)/tools/python/mhsaddthread_sharedmem.py
...
edk-static: edk-base
	...
	$(Q)ln -fs /test_linux_shared_mem_2_slots/hw/edk-base/pcores/* edk-static/pcores/.
            #$(Q)ln -fs //pcores/* edk-static/pcores/.
	#$(Q)ln -fs /home/arkeller/reconos/git/reconos/core/pcores/* edk-static/pcores/.
