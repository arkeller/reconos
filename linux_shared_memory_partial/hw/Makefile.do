...
# we have all the pcores already in the base directory, so no need to link them and no need for these variables
...
BUSMACROS=$(RECONOS)/hw/busmacros/$(TARGET_FAMILY)
...
MAP=map
PAR=par
DUMMY_THREAD_VHDL=$(RECONOS)/hw/samples/dummy_ul.vhd
