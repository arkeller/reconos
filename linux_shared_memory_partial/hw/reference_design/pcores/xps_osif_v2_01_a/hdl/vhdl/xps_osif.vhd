------------------------------------------------------------------------------
-- xps_osif.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
-- Date:              Mon Dec 15 14:04:23 2008 (by Create and Import Peripheral Wizard)
...
use xps_osif_v2_01_a.user_logic;
...
architecture IMP of xps_osif is
  ...
  ------------------------------------------
  constant USER_MST_NUM_REG               : integer              := 2;
